...
{
    /// <inheritdoc />
    public partial class AddBasicRegistrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommercialPartners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommercialPartners_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrationStatuses_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowsFraction = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InternalLocations_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InternalLocations_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommercialPartners_CompanyId",
                table: "CommercialPartners",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CommercialPartners_CompanyId_Document",
                table: "CommercialPartners",
                columns: new[] { "CompanyId", "Document" },
                unique: true,
                filter: "\"IsDeleted\" = FALSE AND \"Document\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_InternalLocations_CompanyId",
                table: "InternalLocations",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalLocations_CompanyId_WarehouseId_Code",
                table: "InternalLocations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternalLocations_WarehouseId",
                table: "InternalLocations",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrationStatuses_CompanyId",
                table: "RegistrationStatuses",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrationStatuses_CompanyId_Code",
                table: "RegistrationStatuses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subcategories_CompanyId_CategoryId_Name",
                table: "Subcategories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_CompanyId_Document",
                table: "Suppliers",
                columns: new[] { "CompanyId", "Document" },
                unique: true,
                filter: "\"IsDeleted\" = FALSE AND \"Document\" IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitsOfMeasure_CompanyId_Abbreviation",
                table: "UnitsOfMeasure",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_CompanyId_IsDefault",
                table: "Warehouses",
