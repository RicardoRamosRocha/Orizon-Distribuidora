...
public sealed record PaginaResultadoExecucao(ResultadoExecucaoImportacao Resultado, IReadOnlyList<ResultadoExecucaoItem> Itens, int Pagina, int TotalPaginas, int TotalFiltrado);
